...
# -- Demo mode --
# Set DEMO_MODE=true to paper-trade: buys/sells are virtual (no real BNB spent).
# Real on-chain prices are used for all calculations — only blockchain writes are skipped.
